/*
global.cpp - global objects definitions
$Revision: 10 $
...
bool PiggyBack =
    false; // Retain the MEMO structure for use in the subsequent optimization
...
#ifdef LINUX_PORT
int RadioVal =
    -1; // the radio value for queryfile (-1 = not set, 0 = batch, 1 = single)
#else
